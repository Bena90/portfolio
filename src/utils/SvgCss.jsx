...
const SvgCss = (props) => (
  <svg width={24} height={24} heigxmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <path
      fill="#131313"
    ...
    <path
      fill="#1572B6"
      d="m27.613 116.706-8.097-90.813h88.967l-8.104 90.798-36.434 10.102-36.332-10.087z"
    />
    <path
      fill="#33A9DC"
      d="m64.001 119.072 29.439-8.162 6.926-77.591H64.001v85.753z"
    />
    <path
      fill="#fff"
    ...
    <path
      fill="#EBEBEB"
      d="m64.067 95.146-.049.014-12.404-3.35-.794-8.883H39.641l1.561 17.488 22.814 6.333.052-.015V95.146z"
    />
    <path
      fill="#fff"
      d="M77.792 76.886 76.45 91.802l-12.422 3.353v11.588l22.833-6.328.168-1.882 1.938-21.647H77.792z"
    />
    <path
      fill="#EBEBEB"
